...
import UStyle from "../../../src/system/UStyle";
import { auth } from '../../../firebaseConfig';
import {toast} from "../../../src/components/common/Toast";
import { mobxUser } from '../../../src/mobx/mobxUser';
import {TextInputForm} from "../../../src/components/common/Element";
...
export default class Welcome extends Component {
  ...
  render() {
    ...
    return (
        <ImageBackground source={require('../../../src/images/background.jpeg')} resizeMode="cover" style={{ flex: 1, height: UStyle.deviceHeight }}>
